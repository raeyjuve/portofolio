package com.pgd.portofolio.entity;
...
public class TblTabungan {
	...
	// keperluan opentab pegawai
	private String idPegawai;
	private String tipeNasabah;

	private String idBankSmph;
	private String regBO;
	private String namaRegBO;
	...
	@Column(name = "id_event", length = 10)
	...
	@Column(name = "tipe_nasabah", length = 2)
	...
	@Column(name = "id_bank_sampah", length = 10)
	public String getIdBankSmph() {
		return idBankSmph;
	}

	public void setIdBankSmph(String idBankSmph) {
		this.idBankSmph = idBankSmph;
	}

	@Column(name = "reg_bo", length = 20)
	public String getRegBO() {
		return regBO;
	}

	public void setRegBO(String regBO) {
		this.regBO = regBO;
	}

	@Column(name = "nama_reg_bo", length = 100)
	public String getNamaRegBO() {
		return namaRegBO;
	}

	public void setNamaRegBO(String namaRegBO) {
		this.namaRegBO = namaRegBO;
	}
}
